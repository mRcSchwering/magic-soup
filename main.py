...
if __name__ == "__main__":
    ...
    cells.add_cells(
        ...
        proteomes=prtms,
        positions=positions,
        world_mol_map=world.molecule_map,
    )
    ...
    Z = cells.get_protein_activities(proteomes=prtms, X=X)
    ...
    t0 = time.time()
    for i in range(1000):
        time_step(world=world, cells=cells, proteomes=init_pts)
