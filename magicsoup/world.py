...
class World:
    ...
    def new_get_cell_params(self, proteomes: list[list[Protein]]):
        # TODO: this...
        n_doms = len(doms)
    ...
    def __repr__(self) -> str:
        ...
        return (
            "%s(molecules=%r,map_size=%r,mol_degrad=%r,mol_diff_rate=%r,n_max_proteins=%r,trunc_n_decs=%r,n_cells=%s)"
            % (
                clsname,
                self.molecules,
                self.map_size,
