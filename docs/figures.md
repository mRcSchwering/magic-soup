...
_**3.2** Neighbouring cells per cell with increasing cell confluency.
...
_**3.3** Genomes diverge with random recombinations at different rates over time.
Upper row shows percentage of cells which experienced at least 1 mutation.
Lower row shows similarity distributions of each cell to its unmutated genome.
...
_**8.1** Energy and entropy density over time during a simulation.
...
_**9.1** Y over x for probability functions with different parameters.
...
_**9.3** Cell growth at different molecule concentrations.
...
_**9.4** Cell growth with multiple kill- or replicate-conditions.
...
## 11. Kinetics Constants Distributions

![](./img/supporting/constant_distributions.png)

_**11.1** Vmax, Km, Ka distributions of randomly generated proteins.
...
## 12. Kinetics Constants

![](./img/supporting/mm_kinetics.png)

_**12.1** Miachelis-Menten kinetics for multiple substrates with varying Km, Vmax, and n.
...
_**12.2** Allosteric modulation with cooperativity over ligand concentration.
